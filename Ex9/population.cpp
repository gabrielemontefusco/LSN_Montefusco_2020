...
Population :: Population(int N,int M,int L,double exp,double pr_mut,double pr_cross){
...
void Population :: printresult(){
  if(P_r==0){
    ...
    filename=(char *)"IterationAveS6.0";
    print(filename,ave);
    filename1=(char *)"BestPathS6.0";
    print(filename1,best_path);
  }
    if(P_l==0){
    char *filename,*filename1;
    filename=(char *)"IterationAveC6.0";
    print(filename,ave);
    filename1=(char *)"BestPathC6.0";
    print(filename1,best_path);
  }
}

void Population :: printpath(){
  if(P_r==0){
    char* filename;
    filename=(char *)"pathS6.0";
