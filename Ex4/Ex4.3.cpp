...
//storage averages in the vector
  ave_epot.push_back(epsilon*sumpot/n_blockstep);
  av2_epot.push_back(pow(ave_epot[block-1],2));
  ave_ekin.push_back(epsilon*sumkin/n_blockstep);
  av2_ekin.push_back(pow(ave_ekin[block-1],2));
  ave_temp.push_back(eps_kb*sumtemp/n_blockstep);
  av2_temp.push_back(pow(ave_temp[block-1],2));
  ave_etot.push_back(epsilon*sumtot/n_blockstep);
